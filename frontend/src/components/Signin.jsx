...
const Signin = () => {
  return (
    <div className="w-[100%] h-[100%] flex justify-center ">
        ...
        <div className="w-[250px] h-[450px] rounded-md shadow-lg shadow-blue-500 border-black border-[1px] mt-3">

            <div className="font-bold text-center text-2xl text-purple-800 my-3">Sign In</div>
            ...
            {/* e-mail */}
            <div className="border-[1px] border-black rounded-md mx-2 mt-2 flex items-center pl-2 shadow-md shadow-orange-300"><CgMail className="mr-2" /><input type="text" placeholder="g-mail"/></div>
            ...
            {/* btn */}
            <button className="flex justify-center mt-3 border-black bg-orange-400 rounded-lg py-1 px-5 shadow-blue-500 ml-[80px] shadow-md cursor-pointer hover:scale-110 transition-all">Submit</button>
